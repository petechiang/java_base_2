...
public class CharBuffer_test {
	...
	public static void main(String[] args) {
		...
		cBuffer.put('c');
		System.out.println("缓冲器界限值是：" + cBuffer.limit());
		System.out.println("缓冲器位置值是：" + cBuffer.position());
		// 反转
		cBuffer.flip();
		...
		System.out.println("反转并取出缓冲器的第一个值之后的界限值是：" + cBuffer.limit());
		System.out.println("反转并取出缓冲器的第一个值之后的位置值是：" + cBuffer.position());
		...
		System.out.println("清除之后取出缓冲器的第一个值是：" + cBuffer.get());
		System.out.println("清除并取出缓冲器的第一个值之后的界限值是：" + cBuffer.limit());
		System.out.println("清除并取出缓冲器的第一个值之后的位置值是：" + cBuffer.position());
